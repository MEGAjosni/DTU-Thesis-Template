...
% Table formatting
\newcolumntype{C}[1]{>{\centering\arraybackslash}p{#1}} % Custom column type for centered columns
...
\IfFontExistsTF{fonts/NeoSansPro-Medium.otf} {
    ...
    % \titleformat{\subsubsection}{\NeoSansProMed\large}{\thesubsubsection}{1em}{\raggedright}
...
% \captionsetup[figure]{belowskip=-12pt, aboveskip=16pt}
